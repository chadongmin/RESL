 ...
 *           receiver. This count normally advances by 1 for every 1024 chips (~2탎) of STS in BPRF mode, and by 1 for every 5124 chips (~1탎) of STS
...
#define SHORT_ADDR 0x3341 /* "A1" (31 = 1, 32 = 2, 33 = 3, 41 = A) 앵커의 주소. x86 CPU는 리틀 엔디언이므로 순서가 바뀜*/
...
#define RX_BUF_LEN 36 // Must be less than FRAME_LEN_MAX_EX
